...
class PostPolicy
{
    ...
    {
        return $authUser->can('View:Post') || ($authUser->id === $post->user_id && $authUser->hasRole('contributor'));
    }
    ...
    {
        return $authUser->can('Update:Post') || ($authUser->id === $post->user_id && $authUser->hasRole('contributor'));
    }

    public function delete(AuthUser $authUser, Post $post): bool
    {
        return $authUser->can('Delete:Post') || ($authUser->id === $post->user_id && $authUser->hasRole('contributor'));
    }
